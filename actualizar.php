    ...
    <div class="container">
        <div class="row mt-5">
            <?php
             ...
             $id = $_POST['id'];
             $UpdatetSQL = "insert into productos set descripcion='$descripcion', cantidad='$cantidad', precio='$precio',fechaelab='$fechaelab', fechavenc='$fechavenc' where id =$id";
             
             if($conexion->query($UpdateSQL) ===TRUE){
               echo '
               <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">informacion actualizada!</h4>
         <p>Los datos han sido actualizados, puede consultar la informacion de'.$descripcion.' '.$cantidad.'  en la lista .</p>
            <hr>
